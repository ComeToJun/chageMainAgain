...
def main():
    ...
    imega_2_style_gan.dnnlib.submission.submit.set_user_name_override(submit_config.user_name)

    submit_config.task_name = task_name
    submit_config.host_name = host_name

    imega_2_style_gan.dnnlib.submission.submit.run_wrapper(submit_config)
