...
def image_animator(client_ip, time_flag, input_image):
    ...
    parser.add_argument("--config", default='/home/bitproject/Python/API/image_animator/config/vox-adv-256.yaml', help="path to config")
    parser.add_argument("--checkpoint", default='/home/bitproject/Python/API/image_animator/fom_checkpoints/vox-adv-cpk.pth.tar', help="path to checkpoint to restore")
    ...
    parser.add_argument("--driving_video", default='/home/bitproject/Python/API/image_animator/driving_video/source.mp4', help="path to driving video")
    parser.add_argument("--result_video", default='/home/bitproject/Python/API/connector/static/videos/{}_{}.mp4'.format(client_ip, time_flag), help="path to output")
    ...
    parser.set_defaults(find_best_frame=False)
